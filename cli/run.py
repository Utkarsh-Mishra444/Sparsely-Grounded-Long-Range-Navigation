...
def _run_single_simulation(
    ...
    if is_resume and resume_folder:
        ...
        strategy_module_name = (
            ...
            or ('strategies.baseline' if cfg.get('strategy_mode') == 'baseline' else 'strategies.agent_nav')
        )
        ...
        # Build kwargs for strategy initialization
        strategy_kwargs = {
        ...
        # Pass variant-specific params only if the selected StrategyClass supports it.
        # This preserves modularity: base strategies don't need to accept variant_params.
        if 'variant_params' in cfg:
            try:
                ...
                if accepts_var_kwargs or ('variant_params' in params):
                    strategy_kwargs['variant_params'] = cfg['variant_params']
            except Exception:
                # If signature introspection fails, fall back to legacy behavior: do not pass it.
                pass
