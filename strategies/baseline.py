...
class AdvancedStreetViewStrategy(Strategy):
    ...
    def prepare_prompt(self, agent: Any, num_images: int, cardinal_directions: List[str], headings: List[float] | None = None,
        ...
        # ── optional self-positioning enrichment ───────────────────
        ...
        # Get current plan and location estimate
        destination = getattr(agent, 'destination', "the destination")
        ...
        # Add decision history (last 8 decisions in order)
        ...
        # NEW: Summarize the full history analyses if available
        history_summary = ""
        ...
        # Add information about previous visits with cardinal directions and unique IDs
        ...
        prompt = (
            ...
            f"Analyze the images to determine the direction towards {destination}. "
        ...
        # Check if arrival heading is available in observation
        ...
        # Add arrival heading information if available
        #if arrival_heading_info:
            #prompt += arrival_heading_info

        # Add cardinal directions for each option/image using unique IDs
        ...
        # Add movement history and memory
        # if movement_history_text:
        #     prompt += movement_history_text
